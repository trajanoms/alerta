            ...
            children: [
              ...
              Container(
                ...
                child: Builder(
                  builder: (context) {
                    final listparcela =
                        FFAppState().listaDespesasFinanceiro.toList();

                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      shrinkWrap: true,
                      scrollDirection: Axis.vertical,
                      itemCount: listparcela.length,
                      itemBuilder: (context, listparcelaIndex) {
                        final listparcelaItem = listparcela[listparcelaIndex];
                        return Container(
                          decoration: BoxDecoration(
