...
import '/financeiro/nova_receit/nova_receit_widget.dart';
import '/flutter_flow/flutter_flow_theme.dart';
import '/flutter_flow/flutter_flow_util.dart';
import '/flutter_flow/flutter_flow_widgets.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'financeiro_receita_model.dart';
export 'financeiro_receita_model.dart';

class FinanceiroReceitaWidget extends StatefulWidget {
  const FinanceiroReceitaWidget({super.key});

  @override
  State<FinanceiroReceitaWidget> createState() =>
      _FinanceiroReceitaWidgetState();
}

class _FinanceiroReceitaWidgetState extends State<FinanceiroReceitaWidget> {
  late FinanceiroReceitaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FinanceiroReceitaModel());
                        ...
                        await showDialog(
                          ...
                          builder: (dialogContext) {
                            return Dialog(
                              ...
                              child: NovaReceitWidget(),
                            );
                          },
                        );
                      },
                      text: 'gerar nova receita',
                      icon: Icon(
                        Icons.add,
                        size: 24.0,
                      ),
