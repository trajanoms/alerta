                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                _model.apiResulttua =
                                    await RecuperacaoDeSenhaCall.call(
                                  email:
                                      _model.textFieldEmailTextController.text,
                                );

                                if ((_model.apiResulttua?.succeeded ?? true)) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Foi enviado um email de recuperação para você, por gentileza verificar a caixa de entrada e spam.',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .secondaryText,
                                        ),
