                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  FFAppState().constNome =
                                      _model.userLogado!.firstOrNull!.nome!;
                                  FFAppState().user = UserStruct(
                                    nome: _model.userLogado?.firstOrNull?.nome,
                                    tipoUsuario: _model
                                        .userLogado?.firstOrNull?.tipoUsuario,
                                    codCliente: _model
                                        .userLogado?.firstOrNull?.codCliente,
                                    ativo:
                                        _model.userLogado?.firstOrNull?.ativo,
                                    userId: _model.userLogado?.firstOrNull?.uid,
                                  );
                                  safeSetState(() {});
