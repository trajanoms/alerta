...
class BrasilTextField4 extends StatefulWidget {
  const BrasilTextField4({
    Key? key,
    this.width,
    this.height,
    this.value,
...
class _BrasilTextFieldState extends State<BrasilTextField4> {
  @override
