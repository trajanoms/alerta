...
class _NovoProdutoWidgetState extends State<NovoProdutoWidget> {
  ...
  void initState() {
    ...
    _model.especificacoesTextController ??= TextEditingController();
    _model.especificacoesFocusNode ??= FocusNode();
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          isDense: true,
                                          labelText:
                                              'Forneça uma descrição para o produto',
                                          labelStyle: FlutterFlowTheme.of(
                                                  context)
                                              .labelMedium
                                              .override(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.especificacoesTextController,
                                        focusNode:
                                            _model.especificacoesFocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          isDense: true,
                                          labelText:
                                              'Forneça as especificações do produto',
                                          labelStyle: FlutterFlowTheme.of(
                                                  context)
                                              .labelMedium
                                              .override(
                            ...
                            children: [
                              Container(
                                ...
                                child: Visibility(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      final listaImagensTemp = FFAppState()
                                          .listaImagensTemp
                                          .toList();
                                      ...
                                      return SingleChildScrollView(
                                        ...
                                        child: Row(
                                          ...
                                          children: List.generate(
                                              listaImagensTemp.length,
                                              (listaImagensTempIndex) {
                                            final listaImagensTempItem =
                                                listaImagensTemp[
                                                    listaImagensTempIndex];
                                            return Padding(
                                                      ...
                                                      child: ClipRRect(
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(8.0),
                                                        child: Image.network(
                                                          '${listaImagensTempItem.imagemUrl}',
                                                          width: 200.0,
                                                          height: 200.0,
                                                          fit: BoxFit.cover,
                                                        ),
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                _model.inserirProduto =
                                    await LojaRastreadoresTable().insert({
                                  'cliente_id': currentUserUid,
                                  'titulo':
                                  ...
                                  'modelo': '',
                                  'especificacoes':
                                      _model.especificacoesTextController.text,
                                });
                                while (
                                    FFAppState().listaImagensTemp.isNotEmpty) {
                                  await ImagensRastreadoresTable().insert({
                                    'legenda': FFAppState()
                                        .listaImagensTemp
                                        .firstOrNull
                                        ?.legenda,
                                    'imagem_url': FFAppState()
                                        .listaImagensTemp
                                        .firstOrNull
                                        ?.imagemUrl,
                                    'rastreadorloja_id':
                                        _model.inserirProduto?.id,
                                    'user_id': currentUserUid,
                                  });
                                  FFAppState().removeFromListaImagensTemp(
                                      FFAppState()
                                          .listaImagensTemp
                                          .firstOrNull!);
                                  safeSetState(() {});
                                }
                                FFAppState().listaImagensTemp = [];
                                safeSetState(() {});
