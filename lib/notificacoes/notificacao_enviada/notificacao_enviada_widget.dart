...
class NotificacaoEnviadaWidget extends StatefulWidget {
  const NotificacaoEnviadaWidget({
    super.key,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Será enviada uma notificação para ${widget.qtdPessoas?.toString()} ${widget.qtdPessoas! > 1 ? 'usuários' : 'usuário'}. Deseja realmente enviar a notificação?',
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        FFAppState().confirmanofity = true;
                        safeSetState(() {});
                        Navigator.pop(context);
                      },
