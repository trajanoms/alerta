...
import '/notificacoes/modelos_notificacoes/modelos_notificacoes_widget.dart';
...
class _NotificacaoWidgetState extends State<NotificacaoWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.todoClienteUID =
          FFAppState().listaNotifyUID.toList().cast<String>();
      _model.todosClienteNome =
          FFAppState().listaNotifyNome.toList().cast<String>();
      safeSetState(() {});
    });
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                hintText:
                                                    'Dê um título para a notificação',
                                                hintStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        .override(
                                                                    ...
                                                                    return Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          _model
                                                                              .addToTodoClienteUID(listaSeachItem.uid!);
                                                                          _model
                                                                              .addToTodosClienteNome(listaSeachItem.nome!);
                                                                          safeSetState(
                                                                              () {});
                                                                          safeSetState(
                                                                              () {
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Theme(
                                          ...
                                          child: Checkbox(
                                            value: _model
                                                .checkboxSalvarValue ??= false,
                                            onChanged: (newValue) async {
                                              safeSetState(() =>
                                                  _model.checkboxSalvarValue =
                                                      newValue!);
                                            },
                                            side: BorderSide(
                                              width: 2,
                                                      ...
                                                      await NotificacoesTable()
                                                        ...
                                                        'data_envio':
                                                            supaSerialize<
                                                                ...
                                                                _model
                                                                    .datePicked1),
                                                        'hora_envio': supaSerialize<
                                                                PostgresTime>(
                                                            PostgresTime(_model
                                                                .datePicked2)),
                                                        'criado_por':
                                                            currentUserUid,
                                                        'cliente_nome': FFAppState()
                                                            .listaNotifyNome
                                                            .elementAtOrNull(
                                                                _model
                                                                    .contador!),
                                                        'cliente_uid': FFAppState()
                                                            .listaNotifyUID
                                                            .elementAtOrNull(
                                                                _model
                                                                    .contador!),
                                                        'salvar_modelo': _model
                                                            .checkboxSalvarValue,
                                                      });
                                                    } else {
                                                      await NotificacoesTable()
                                  ...
                                  child: Padding(
                                    ...
                                    child: FutureBuilder<List<NotificacoesRow>>(
                                      future: (_model.requestCompleter ??=
                                              Completer<List<NotificacoesRow>>()
                                                ..complete(NotificacoesTable()
                                                    .queryRows(
                                                  queryFn: (q) => q,
                                                )))
                                          .future,
                                      builder: (context, snapshot) {
                                        ...
                                        return ListView.separated(
                                          ...
                                          itemCount: listViewNotificacoesRowList
                                              .length,
