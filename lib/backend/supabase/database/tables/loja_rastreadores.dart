...
class LojaRastreadoresTable extends SupabaseTable<LojaRastreadoresRow> {
  @override
  String get tableName => 'loja_rastreadores';

  @override
  LojaRastreadoresRow createRow(Map<String, dynamic> data) =>
      LojaRastreadoresRow(data);
}

class LojaRastreadoresRow extends SupabaseDataRow {
  LojaRastreadoresRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => LojaRastreadoresTable();
