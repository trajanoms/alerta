...
class ViewPingsCompletaTable extends SupabaseTable<ViewPingsCompletaRow> {
  @override
  String get tableName => 'view_pings_completa';

  @override
  ViewPingsCompletaRow createRow(Map<String, dynamic> data) =>
      ViewPingsCompletaRow(data);
}

class ViewPingsCompletaRow extends SupabaseDataRow {
  ViewPingsCompletaRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewPingsCompletaTable();
