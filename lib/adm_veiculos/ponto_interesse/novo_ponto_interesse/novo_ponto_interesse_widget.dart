...
import 'novo_ponto_interesse_model.dart';
export 'novo_ponto_interesse_model.dart';

class NovoPontoInteresseWidget extends StatefulWidget {
  const NovoPontoInteresseWidget({super.key});

  @override
  State<NovoPontoInteresseWidget> createState() =>
      _NovoPontoInteresseWidgetState();
}

class _NovoPontoInteresseWidgetState extends State<NovoPontoInteresseWidget> {
  late NovoPontoInteresseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NovoPontoInteresseModel());
                                                              ...
                                                              child: RichText(
                                                                ...
                                                                text: TextSpan(
                                                                  children: [
                                                                    TextSpan(
                                                                      text:
                                                                          'Distância para notificação (em  metros)',
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
                                                                          .override(
                                                            ...
                                                            Container(
                                                              ...
                                                              child:
                                                                ...
                                                                onChanged: (_) =>
                                                                  ...
                                                                  () async {
                                                                    _model
                                                                        .radiusValue = double.tryParse(_model
                                                                            .raioCercaTextController
                                                                            .text) ??
                                                                        0.0;
                                                                    safeSetState(
                                                            ...
                                                            FlutterFlowDropDown<
                                                              ...
                                                              controller: _model
                                                                  ...
                                                                  FormFieldController<
                                                                      ...
                                                                      null),
                                                              options: [
                                                                'Selecione o ponto de interesse'
                                                              ],
                                                              onChanged: (val) =>
                                                                  safeSetState(() =>
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              ...
                                              text: 'Salvar ponto de interesse',
                                              icon: Icon(
                                                Icons.check_rounded,
                                                size: 16.0,
                                              ),
