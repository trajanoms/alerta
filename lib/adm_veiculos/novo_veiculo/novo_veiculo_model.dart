...
import 'novo_veiculo_widget.dart' show NovoVeiculoWidget;
import 'package:flutter/material.dart';

class NovoVeiculoModel extends FlutterFlowModel<NovoVeiculoWidget> {
  ...
  RastreadoresRow? rastreUser;

  ///  State fields for stateful widgets in this component.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  // State field(s) for ClienteDropdown widget.
  String? clienteDropdownValue;
  FormFieldController<String>? clienteDropdownValueController;
  // Stores action output result for [Backend Call - Query Rows] action in ClienteDropdown widget.
  List<UserRow>? outUser;
  // State field(s) for associado widget.
  String? associadoValue;
  FormFieldController<String>? associadoValueController;
  // Stores action output result for [Backend Call - Query Rows] action in associado widget.
  List<RastreadoresRow>? rastaUser;
