...
import 'nova_cerca_virtual_model.dart';
export 'nova_cerca_virtual_model.dart';

class NovaCercaVirtualWidget extends StatefulWidget {
  const NovaCercaVirtualWidget({super.key});

  @override
  State<NovaCercaVirtualWidget> createState() => _NovaCercaVirtualWidgetState();
}

class _NovaCercaVirtualWidgetState extends State<NovaCercaVirtualWidget> {
  late NovaCercaVirtualModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NovaCercaVirtualModel());
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Flexible(
                                            child: Text(
                                              'Selecione o ponto central da cerca no mapa preencha o endereço diretamente na sessão abaixo. ',
                                              style:
                                                    ...
                                                    Container(
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        decoration:
                                                          ...
                                                          hintText:
                                                              'Digite o nome da Cerca Virtual',
                                                          hintStyle:
                                                              FlutterFlowTheme.of(
                                                                      context)
                                                                  .labelMedium
                                                          ...
                                                          Container(
                                                            ...
                                                            child:
                                                              ...
                                                              onChanged: (_) =>
                                                                  EasyDebounce
                                                                      .debounce(
                                                                '_model.raioCercaTextController',
                                                                Duration(
                                                                    milliseconds:
                                                                        2000),
                                                                () async {
